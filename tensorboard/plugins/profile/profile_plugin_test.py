...
class ProfilePluginTest(tf.test.TestCase):
    ...
    def testData(self):
        ...
        self.assertEqual(
            None,
            self.plugin.data_impl(self.makeRequest("foo", "nonono", "host0")),
        )
        self.assertEqual(
            None,
            self.plugin.data_impl(self.makeRequest("foo", "trace_viewer", "")),
        )
        self.assertEqual(
            None,
            self.plugin.data_impl(
        ...
        self.assertEqual(
            None,
            self.plugin.data_impl(self.makeRequest("a", "trace_viewer", "")),
        )
